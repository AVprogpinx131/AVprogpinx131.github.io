...
fig = plt.gcf()
fig.canvas.set_window_title('Mängu joonis joone kujul')

plt.plot(guesses_x, points_y_1, marker='.', label="Tase 1")
plt.plot(guesses_x, points_y_2, marker='.', label="Tase 2")
plt.plot(guesses_x, points_y_3, marker='.', label="Tase 3")
plt.plot(guesses_x, points_y_4, marker='.', label="Tase 4")
plt.plot(guesses_x, points_y_5, marker='.', label="Tase 5")
plt.plot(guesses_x, points_y_6, marker='.', label="Tase 6")
plt.plot(guesses_x, points_y_7, marker='.', label="Tase 7")
plt.plot(guesses_x, points_y_8, marker='.', label="Tase 8")
